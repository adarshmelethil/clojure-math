...
(defn triangle-from-string [triangle-str]
 (vec (map #(vec (map (fn [val] (. Integer parseInt val)) (clojure.string/split % #" ")))
   (clojure.string/split
    (clojure.string/trim triangle-str) #"\n"))))

(def small-triangle
 (triangle-from-string small-triangle-string))
